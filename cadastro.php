...
<div class="row no-gutters block-9">
  <div class="col-md-6 order-md-last d-flex">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        <input type="text" class="form-control" name="nomepet" id="nomepet" placeholder="Nome do pet">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <input type="submit" value="Cadastrar" name="cadastro" class="btn btn-secondary py-3 px-5 ">
      </div>
     <div class="form-group">
